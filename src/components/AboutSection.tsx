            ...
            <div className={styles.container}>
                ...
                <article className={styles.textWrapper} aria-labelledby="about-heading">
                    ...
                    <p className={styles.description}>
                        ...
                        <br /><br />
                        Com dedicação e seriedade, atuo exclusivamente em causas voltadas ao Direito Previdenciário, auxiliando meus clientes na conquista do melhor benefício junto ao INSS, sempre de forma justa, segura e estratégica. Sou advogada regularmente inscrita na <strong>OAB/PE nº 60.655</strong>, comprometida com a ética profissional e a excelência na atuação.
                        <br /><br />
